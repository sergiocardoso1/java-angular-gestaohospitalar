...
public class EspecialidadeController {
	...
	public ResponseEntity<Especialidade> findId(@PathVariable Integer id) {
		Especialidade obj = service.findId(id);
		return ResponseEntity.ok().body(obj);
	}

	@RequestMapping(method = RequestMethod.POST)
	public ResponseEntity<Especialidade> insert(@Valid @RequestBody EspecialidadeNewDTO objDto) {
	...
	public ResponseEntity<List<Especialidade>> findAll() {
		List<Especialidade> obj = service.findAll();
		return ResponseEntity.ok().body(obj);
	}
